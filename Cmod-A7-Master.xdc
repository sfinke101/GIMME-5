...
## 12 MHz Clock Signal
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { clk_top }]; #IO_L12P_T1_MRCC_14 Sch=gclk
create_clock -add -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports {clk_top}];

## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { ld1 }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
...
## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { rst_top }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
#set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L19P_T3_16 Sch=btn[1]

## Pmod Header JA
##set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { rect_out_top }]; #IO_L5N_T0_D07_14 Sch=ja[1]
##set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { saw_pmod }]; #IO_L4N_T0_D05_14 Sch=ja[2]
##set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { sine_pmod }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
...
##set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { Out_L }]; #IO_L2N_T0_34 Sch=pio[27]
#set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { Out_R_scale }]; #IO_L1P_T0_34 Sch=pio[28]
...
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { Out_R_scale }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { Out_R_scale }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
